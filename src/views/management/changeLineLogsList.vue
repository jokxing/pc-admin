<template>
    <div class="changeLineLogs_list">
        <el-page-header @back="$router.go(-1)" content="调线记录"></el-page-header>
        ...
        <el-row>
            <el-table
                ...
                v-loading="tableLoading">
                    ...
                    <el-table-column
                        prop="post_member_realname"
                        label="昵称">
                    </el-table-column> 
                    <el-table-column
                        prop="before_created_at"
                        label="注册时间">
                    </el-table-column> 
                    <el-table-column
                        label="状态">
...
<script>
    import { ChangeLineLogsListApi } from '../../http/api.js';
    ...
    export default {
        ...
        methods: {
            changeLineLogsListData () {
                ...
                ChangeLineLogsListApi(_this.ruleForm).then(res => {
